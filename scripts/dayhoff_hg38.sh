#!/bin/bash
#SBATCH --job-name=retro_3muestras_hg38
#SBATCH --output=logs/retro_3muestras_hg38_%j.log
#SBATCH --error=logs/retro_3muestras_hg38_%j.err
...
echo ""
echo "=== Lanzando Nextflow (T2T): $(date) ==="
cd "$PIPE_DIR"
